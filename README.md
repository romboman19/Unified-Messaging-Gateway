...
\* SMS реалізовано повністю, але ще не перевірено на живому залізі —
GSM-шлюз до сервера поки не підключали.
...
- SMS через GoIP — сервер розгорнутий і адаптер написаний під його справжній
  API, але жодна SIM ще не підключалася, тож наскрізного проходу не було.
