  ...
  async function copyToken() {
    ...
    try {
      if (navigator.clipboard && window.isSecureContext) {
        ...
        // or localhost); UMG is commonly reached over plain http:// on a
        // LAN, where writeText silently throws — fall back to the legacy
        // execCommand copy via a hidden textarea.
